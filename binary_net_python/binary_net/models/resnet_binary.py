...
class ResNet_cifar10(ResNet):
    ...
    def __init__(self, num_classes=10,
        ...
        self.layer3 = self._make_layer(block, 32*self.inflate, n, stride=2,do_bntan=False)
        #can not convert to onnx
        self.layer4 = lambda x: x
        self.avgpool = nn.AvgPool2d(8)
        self.bn2 = nn.BatchNorm1d(32*self.inflate)
        self.bn3 = nn.BatchNorm1d(10)
        self.logsoftmax = nn.LogSoftmax()
        self.fc = BinarizeLinear(32*self.inflate, num_classes)
